<div class="w-full bg-white rounded-lg shadow dark:bg-gray-800 p-4 md:p-6">
    ...
    <div class="flex justify-between items-start w-full">
        <div class="flex-col items-center">
          <div class="flex items-center mb-1">
              <h5 class="text-xl font-bold leading-none text-gray-900 dark:text-white mr-1">Product Category</h5>
  ...
  <script>
    ...
    window.addEventListener("load", function() {
        ...
        .then(data => {
            ...
            const getChartOptions = () => {
                return {
                    series: rest.series,
                    colors: ["#1C64F2", "#16BDCA", "#9061F9", "#ebde34", "#8934eb", "#eb34c3"],
                    chart: {
                        height: 420,
                        width: "100%",
                        type: "pie",
    ...
    function pieData(data)
    {
      ...
      {
          series.push(Math.round(data[i].category_percentage));
      }
